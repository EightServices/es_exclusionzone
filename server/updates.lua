CreateThread(function()
    local url = "https://raw.githubusercontent.com/EightServices/es_exclusionzone/master/version.txt"

    local function getExclusionzoneVersion()
    ...
    local local_version = getExclusionzoneVersion()
